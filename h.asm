...
start:              ; start label from where our code starts
    ...
    call _print_WhiteColor_String        ; call print different color string function


    mov si,press_key                    ; point press_key string to source index
    call _print_YellowColor_String       ; call print green color string function
    ...
    start_os_intro db 'Leo OS!',0
    press_key db '>>>> Press any key to Login<<<<',0

    login_username db 'Username : ',0
    login_password db 'Password : ',0
    
    display_text db '! Welcome to Leo OS !', 0

    os_info db 10, 'My Operating System, 16-Bit, version=1.0.0',13,0

    press_key_2 db 10,'Press any key See Hardware Informations',0

    window_text db 10,'Your Hardware Infornmations', 0
